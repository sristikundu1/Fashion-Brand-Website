...
const AddProduct = () => {
    ...
    const handleAddProduct = event => {
        ...
        fetch("https://new-brand-2no4d40p9-sristikundu2468-gmailcom.vercel.app/products", {
            method: 'POST',
            headers: {
    ...
    return (
        <div>
            <div className="card card-compact  shadow-xl bg-[#F4F3F0] w-96 p-5 ml-4 md:w-[700px] md:ml-8 md:p-12 lg:w-[1000px] lg:p-16 mt-12 lg:mx-44 mb-24 ">
                <figure><img className="w-full md:w-full lg:w-full" src="https://i.ibb.co/C8nXfg3/addproduct.jpg" alt="Shoes" /></figure>
